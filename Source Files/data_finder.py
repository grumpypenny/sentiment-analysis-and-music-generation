...
def make_csv(string_list):
    ...
    """
    with open(f"{sys.argv[2]}.csv", "w", encoding="utf-8", newline="") as file:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("usage: py data_finder.py abc_file csv_file")
        print("enter the path to the folder where your abc files are kept")
        print("then enter the name of the csv you want to create")
        exit(0)
